...
(function(exports) {
  ...
  var Node_Stream = PS["Node.Stream"];
  var Prelude = PS["Prelude"];                 
  var SpeedtestResult = function (x) {
      return x;
  };                                        
  var showSpeedtest = new Data_Show.Show(function (v) {
      return "{\"download\": \"" + (v.download + ("\",\"upload\": \"" + (v.upload + ("\", \"host\": \"" + (v.host + ("\", \"source\": \"" + (v.source + "\"}")))))));
  });
  var lines = Data_String_Common.split("\\n");
  var is = Data_Maybe.maybe(false)(Data_Function["const"](true));
  ...
  var addToRecord = function (rec) {
      return function (row) {
          if (is(Data_String_CodePoints.indexOf("Download")(row))) {
              var $15 = {};
              for (var $16 in rec) {
                  if ({}.hasOwnProperty.call(rec, $16)) {
                      $15[$16] = rec[$16];
                  };
              };
              $15.download = row;
          ...
          if (is(Data_String_CodePoints.indexOf("Hosted")(row))) {
              var $18 = {};
              for (var $19 in rec) {
                  if ({}.hasOwnProperty.call(rec, $19)) {
                      $18[$19] = rec[$19];
                  };
              };
              $18.host = row;
          ...
          if (is(Data_String_CodePoints.indexOf("Testing from")(row))) {
              var $21 = {};
              for (var $22 in rec) {
                  if ({}.hasOwnProperty.call(rec, $22)) {
                      $21[$22] = rec[$22];
                  };
              };
              $21.source = row;
          ...
          if (is(Data_String_CodePoints.indexOf("Upload")(row))) {
              var $24 = {};
              for (var $25 in rec) {
                  if ({}.hasOwnProperty.call(rec, $25)) {
                      $24[$25] = rec[$25];
                  };
              };
              $24.upload = row;
          ...
          throw new Error("Failed pattern match at Speedtest line 41, column 1 - line 46, column 20: " + [ rec.constructor.name, row.constructor.name ]);
      };
  };
  var resultToReply = function (dictShow) {
      return function (v) {
          return SpeedtestResult(Data_Foldable.foldl(Data_Foldable.foldableArray)(addToRecord)(defaultSpeedtest)(lines(Data_Show.show(dictShow)(v.stdout))));
      };
  };
  var contSpeedtest = function (f) {
      return function __do() {
          var v = Node_ChildProcess.exec("speedtest-cli")(Node_ChildProcess.defaultExecOptions)(function ($29) {
              return f(resultToReply(Node_Buffer.showBuffer)($29));
          })();
  ...
  exports["defaultSpeedtest"] = defaultSpeedtest;
  exports["is"] = is;
  exports["addToRecord"] = addToRecord;
  exports["resultToReply"] = resultToReply;
  exports["contSpeedtest"] = contSpeedtest;
  exports["showSpeedtest"] = showSpeedtest;
})(PS["Speedtest"] = PS["Speedtest"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  ...
  var Mqtt = PS["Mqtt"];
  var Prelude = PS["Prelude"];
  var Speedtest = PS["Speedtest"];                 
  var publishSpeedtest = function (topic) {
  ...
  var main = (function () {
      var runSpeedtest = function (v) {
          if (v instanceof Data_Either.Right) {
              return Control_Monad_Cont_Trans.runContT(Speedtest.contSpeedtest)(function ($14) {
                  return publishSpeedtest("speedtest")(v.value0.host)(v.value0)(Data_Show.show(Speedtest.showSpeedtest)($14));
              });
          };
          if (v instanceof Data_Either.Left) {
          ...
          throw new Error("Failed pattern match at MainSpeedtest line 36, column 5 - line 36, column 101: " + [ v.constructor.name ]);
      };
      return function __do() {
          var v = Data_Config_Node.fromEnv(Effect_Class.monadEffectEffect)("MQTT")(mqttConfig)();
          return runSpeedtest(v)();
      };
  })();
  exports["mqttConfig"] = mqttConfig;
  exports["main"] = main;
  exports["publishSpeedtest"] = publishSpeedtest;
})(PS["MainSpeedtest"] = PS["MainSpeedtest"] || {});
PS["MainSpeedtest"].main();